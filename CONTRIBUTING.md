...
This is the issue tracker for Jordan Hawker CLI. We use this site
to collect and track bugs and discussions of new features. If you are having
difficulties with this CLI or have a question about usage please 
[create an issue](https://github.com/elwayman02/jordan-hawker-cli/issues/) 
or ask a question on 
[Stack Overflow](http://stackoverflow.com/questions/ask?tags=Jordan-Hawker+command-line-interface).
...
correctness. The team will work with you until your issue can
be verified.
...
All inline documentation is written using [YUIDoc](http://yui.github.io/yuidoc/).

And in case we didn't emphasize it enough: we love tests!

NOTE: Partially copied & altered from https://github.com/elwayman02/Js.Edgar/blob/master/CONTRIBUTING.md
